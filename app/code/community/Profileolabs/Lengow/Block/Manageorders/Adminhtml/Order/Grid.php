<?php
/**
 * Adminhtml sales orders lengow grid
 *
 * @category   Lengow
...
class Profileolabs_Lengow_Block_Manageorders_Adminhtml_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addAttributeToFilter('from_lengow',1);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('order_id_lengow', array(
            'header' => Mage::helper('profileolabs_lengow')->__('Id lengow'),
            'index' => 'order_id_lengow',
        ));
        
        $this->addColumn('marketplace_lengow', array(
            'header' => Mage::helper('profileolabs_lengow')->__('Marketplace'),
