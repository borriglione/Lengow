 ...
 */
class Profileolabs_Lengow_Block_Export_Adminhtml_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('lengow_product',
            array(
                'header'=> Mage::helper('catalog')->__('Importé dans Lengow'),
                'width' => '70px',
        ...
        $this->getMassactionBlock()->addItem('publish', array(
             ...
             'additional' => array(
                    'visibility' => array(
                         ...
                         'label' => Mage::helper('profileolabs_lengow')->__('Publication'),
                         'values' => $optionsLw
                     )
             )
        ));
